...
{
    class EnchantingWindow : GuiWindow
    {
            ...
            : base(0, 0, 272, 200, true, true, false, true, true)
        {
            ...
            y += l.Height + 10;
            EnchantingBox i = new EnchantingBox(this, new XnaRect(5, y, 240, 100), type, -1);//AddEnchantingBox(new XnaRect(5, y, 240, 100), type);
            controls.Add(i);
                ...
                if (Gui.Ms.X >= dx && Gui.Ms.Y >= dy && Gui.Ms.X < dx + Width && Gui.Ms.Y < dy + Height) //Mouse within bounds of box?
                {
                    if (Gui.DragItem != null)
                        ...
                        else
                        {
                            ...
                            int cost = EnchantCost(Gui.DragItem);
