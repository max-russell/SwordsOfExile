...
{
    delegate void PressControlHandler(Control control_pressed);//string option);
    ...
    class Button : Control
    {
        ...
        string caption;
        public string Caption { get { return caption; } set { caption = value; Resize(Width, Height); } }
        Vector2 textPos = Vector2.Zero;
        BitmapFont Font = Gfx.GuiFont1;

        const int edge_width = 6, edge_height = 6,
        ...
        public override void Draw(SpriteBatch sb, int xOffset, int yOffset)
        {
            ...
            Texture2D tex = Gfx.NewGui;

            Color shade = Enabled ? Color.White : Color.DimGray;
        ...
        protected virtual bool DrawAsPressed {get{return Pressed;}}
    }
}