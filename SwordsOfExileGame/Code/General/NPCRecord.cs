...
public class NPCRecord : IListEntity//Formerly monster_record_type - bit of consistency, eh?
{
    ...
    public static ExileList<NPCRecord> List = new();
    ...
    private string DeathSoundA, DeathSoundB;
    ...
    {
        var summonList = new Dictionary<string, string>();
    ...
    public XnaRect GetGraphic(bool facing_right, bool attacking, out Texture2D stex)
    {
        ...
        else if (Width == 2 && Height == 1)
        {
            ...
            {
                var sr = new XnaRect((facing_right ? 0 : Gfx.CHARGFXWIDTH * 2)
        ...
        else if (Width == 1 && Height == 2)
        {
            ...
            {
                var sr = new XnaRect((facing_right ? 0 : Gfx.CHARGFXWIDTH)
                                     + (attacking ? Gfx.CHARGFXWIDTH * 2 : 0)
